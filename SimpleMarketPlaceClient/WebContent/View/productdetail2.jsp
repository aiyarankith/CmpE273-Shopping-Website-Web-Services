...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
        	...
        	<a  rel="lightbox[portfolio]" href="images/product/12.jpg" title="<%=session.getAttribute("p_name2")%>"><img src="images/product/11.jpg" alt="Image 10" /></a>
            </div>
            <div class="col col_13 no_margin_right">
                <table>
                    <tr>
                        <td height="30" width="160">Price:</td>
                        <td>$ <%=session.getAttribute("p_price2") %></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><%=session.getAttribute("p_id2") %></td>
                    </tr>
                    <tr>
                        <td height="30">Manufacturer:</td>
                        <td>Apple</td>
                    </tr>
                    <tr><td height="30">Quantity </td><td><%=session.getAttribute("p_qty2") %></td></tr>
                </table>
                <div class="cleaner h20"></div>
            ...
            <p><%=session.getAttribute("p_desc2") %></p>
