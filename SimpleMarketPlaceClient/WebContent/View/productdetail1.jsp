...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
        	...
        	<a  rel="lightbox[portfolio]" href="images/product/11.jpg" title="Apple Mac Book Pro"><img src="images/product/11.jpg" alt="Image 10" /></a>
            </div>
            <div class="col col_13 no_margin_right">
                <table>
                    <tr>
                        <td height="30" width="160">Price:</td>
                        <td>$ <%=session.getAttribute("p_price1") %></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><%=session.getAttribute("p_id1") %></td>
                    </tr>
                    <tr>
                        <td height="30">Manufacturer:</td>
                        <td>HP</td>
                    </tr>
                    <tr><td height="30">Quantity </td><td> <%=session.getAttribute("p_qty1") %></td></tr>
                </table>
                <div class="cleaner h20"></div>
            ...
            <p><%=session.getAttribute("p_desc1") %></p>
